...
* the structural properties, stability and (electro)chemical/catalytic activity of bare and admetal modified metal single crystal electrodes.
* fundamental processes during high voltage electrolysis, including contact glow discharge electrolysis, at the electrode, the gas/plasma, and the electrolyte, as well as the interfaces.
...
* developing a metadata schema for [electrochemical data](https://github.com/echemdb/metadata-schema), which allows comparing local data with [published data](https://www.echemdb.org/cv)
* [data extraction](https://echemdb.github.io/svgdigitizer/) from publications.

I also explore using mediawiki as en electronic lab notebook.
...
As movie enthusiast, I co-founded in 2008 the non profit organization [feierblumm](https://feierblumm.com/), which emerged from the production of several feature films, short films, music videos etc. The organization supports artists who take their first steps in audio visual production. Though I am not an active member anymore I still think it is a noteworthy project which kept me busy during my studies.😏
